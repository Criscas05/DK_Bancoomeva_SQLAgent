...
export function Chat() {
  ...
  const handleSubmit = async (text?: string) => {
    ...
    if (!selectedCatalog || !selectedSchema) {
      alert("⚠️ Por favor selecciona un catálogo y un esquema antes de enviar la pregunta.");
      return;
    }
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/ask`, {
        ...
        body: JSON.stringify({
          ...
          catalog: selectedCatalog,  // 👈 Usar el seleccionado
          ...
          return (
            <div key={userMsg.id} className="space-y-4">
              <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg border border-gray-300 dark:border-gray-600 shadow-sm">
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">🙋‍♂️ Usuario:</p>
              ...
              {assistantMsg && (
                <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-300 dark:border-gray-600 shadow-inner">
                  <p className="text-sm font-medium text-indigo-700 dark:text-indigo-300 mb-2">🤖 Asistente:</p>
                    ...
                    <button
                      ...
                      <button
                        ...
                        <button
                            ...
                            className="p-2 rounded-md border dark:border-zinc-700 hover:bg-muted transition"
                            title={showChart[assistantMsg.id] ? "Ocultar gráfico" : "Mostrar gráfico"}
                          >
                            <BarChart3 size={18} />
                          </button>
